...
def normalise_input(user_input):
    ...
    output = remove_punct(user_input)
...
def print_menu(exits):
    ...
    for cardinal in exits:
        leads_to_name = exit_leads_to(exits, cardinal)
        print_menu_line(cardinal, leads_to_name)
...
def is_valid_exit(exits, user_input):
    ...
    for cardinal in exits:
        if cardinal == normalise_input(user_input):
            out = True
...
def menu(exits):
    ...
    while True:
        ...
        cardinal = input()
        while not is_valid_exit(exits, cardinal) == True:
            print("That was an invalid exit, please enter another:")
            cardinal = input()
...
def move(exits, direction):
    ...
    cardinal = normalise_input(direction)
    output = rooms[exits[cardinal]]

    if is_valid_exit(exits, cardinal) == True:
        return(output)
